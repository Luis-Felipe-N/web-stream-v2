...
export interface StreamPlayerProps extends StreamPlayer {
    thumbnail?: string;
    i18n?: I18n;
    shortcuts?: Shortcuts;
    hotkeys?: HotKey[];
...
export const VideoPropsContext =
    // @ts-ignore
    React.createContext<Required<StreamPlayerProps>>(null);

export const VideoPropsProvider: React.FC<Partial<StreamPlayerProps>> = ({
    children,
    ...props
}) => {
...
export const useVideoProps = () => {
    const value = React.useContext(VideoPropsContext);
