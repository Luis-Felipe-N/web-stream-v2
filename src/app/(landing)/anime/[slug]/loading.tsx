...
export default function Loading() {
    return (
        <main>
            <div className='lg:h-[80vh] md:h-[60vh] h-[50vh]'>
                ...
                <div className='mb-24'>
                    <section className="lg:px-24 lg:py-8 p-4 relative z-20">
                        <strong className="lg:text-xl">
                            <Skeleton className='w-[230px] h-[60px]'></Skeleton>
                        </strong>

                        <div className='flex mt-4 gap-8'>
                            <Skeleton className='aspect-3/2 lg:w-full  md:w-[10rem] md:h-[14.62rem] w-[8rem] h-[11.69rem] border-2'></Skeleton>
                            <Skeleton className='aspect-3/2 lg:w-full  md:w-[10rem] md:h-[14.62rem] w-[8rem] h-[11.69rem] border-2'></Skeleton>
                            <Skeleton className='aspect-3/2 lg:w-full  md:w-[10rem] md:h-[14.62rem] w-[8rem] h-[11.69rem] border-2'></Skeleton>
                            <Skeleton className='aspect-3/2 lg:w-full  md:w-[10rem] md:h-[14.62rem] w-[8rem] h-[11.69rem] border-2'></Skeleton>
